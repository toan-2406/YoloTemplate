...
export default function RecentActivityNFT() {
  ...
  return (
    <>
      ...
      <Row align="middle" className="hp-mb-18 hp-bg-black-0 hp-bg-dark-100 hp-border-1 hp-border-color-black-40 hp-border-color-dark-80 hp-border-radius hp-p-8">
        <Col>
          <div
      ...
      <Row align="middle" className="hp-bg-black-0 hp-bg-dark-100 hp-border-1 hp-border-color-black-40 hp-border-color-dark-80 hp-border-radius hp-p-8">
        <Col>
          <div
            className="hp-mr-18 hp-border-radius"
